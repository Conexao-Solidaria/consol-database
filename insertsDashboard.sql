INSERT INTO Titular (nome, rg, cpf, data_nascimento, telefone1, telefone2, estado_civil, escolaridade, trabalhando, ocupacao, referencia_s3, fk_familia)
VALUES 
...
('Lucas Pereira', '234567891', '44455566677', '2018-08-12', '9876541230', NULL, 'Solteiro', 'Fundamental', 0, 'Estudante', 'referencia_lucas', 4),
('Mariana Costa', '345678912', '55566677788', '2023-05-05', '3456781234', NULL, 'Solteiro', 'Pré-escolar', 0, 'Estudante', 'referencia_mariana', 5);
...
('Carla Mendes', '234567891', '44455566677', '2000-04-22', '9876541230', NULL, 'Solteiro', 'Ensino Médio', 1, 'Estudante', 'referencia_carla', 4),
('Roberto Costa', '345678912', '55566677788', '1990-08-19', '3456781234', NULL, 'Solteiro', 'Ensino Fundamental', 1, 'Motorista', 'referencia_roberto', 5);
...
('Roberto Oliveira', '234567891', '44455566677', '1970-04-10', '9876541230', NULL, 'Casado', 'Ensino Médio', 1, 'Técnico', 'referencia_roberto', 4),
('Patrícia Mendes', '345678912', '55566677788', '1965-08-19', '3456781234', NULL, 'Viúva', 'Ensino Superior', 1, 'Administradora', 'referencia_patricia', 5);
...
('Célia Lima', '234567891', '44455566677', '1952-01-30', '9876541230', NULL, 'Solteira', 'Ensino Médio', 1, 'Técnica de Enfermagem', 'referencia_celia', 4),
('Cláudio Rocha', '345678912', '55566677788', '1945-08-19', '3456781234', NULL, 'Divorciado', 'Pós-graduação', 1, 'Engenheiro', 'referencia_claudio', 5);
...
INSERT INTO `consol`.`doacao` (id_doacao, descricao, data_doacao, flag_doacao_entregue, fk_instituicao, fk_titular) VALUES
(6, 'Doação de alimentos não perecíveis', '2024-10-01 10:00:00', 1, 1, 6),  -- Titular: José da Silva
(7, 'Doação de roupas infantis', '2024-10-02 12:30:00', 1, 1, 7),         -- Titular: Maria Pereira
(8, 'Doação de produtos de higiene', '2024-10-03 09:15:00', 1, 1, 8),     -- Titular: Antônio Souza
(9, 'Doação de brinquedos', '2024-10-04 11:45:00', 1, 1, 9),             -- Titular: Célia Lima
(10, 'Doação de material escolar', '2024-10-05 14:00:00', 1, 1, 10),      -- Titular: Cláudio Rocha
(11, 'Doação de roupas para adultos', '2024-10-10 15:30:00', 1, 1, 11),    -- Titular: Ana Costa
(12, 'Doação de alimentos para pets', '2024-10-15 08:00:00', 1, 1, 12); 